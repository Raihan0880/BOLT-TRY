...
export const WeatherAdvice: React.FC<WeatherAdviceProps> = ({ userPreferences }) => {
  ...
  return (
    <div className="h-full bg-gray-50 p-6 overflow-y-auto">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Weather-Based Advice</h1>
          <p className="text-gray-600">Get farming recommendations based on local weather conditions</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg p-6">
            ...
            {/* Farming Advice */}
            <div>
              <h3 className="text-lg font-semibold text-gray-800 mb-4">Today's Farming Advice</h3>
