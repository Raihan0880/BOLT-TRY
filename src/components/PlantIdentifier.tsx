...
export const PlantIdentifier: React.FC<PlantIdentifierProps> = ({ userPreferences }) => {
  ...
  return (
    <div className="h-full bg-gray-50 p-6">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">Plant Identification</h1>
          <p className="text-gray-600">Upload a photo to identify plants and get health recommendations</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            {!selectedImage ? (
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center">
                ...
                <p className="text-gray-600 mb-4">Upload a clear photo of your plant</p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            {!result ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">Upload an image to see identification results</p>
              </div>
            ) : (
              <div className="space-y-6">
                ...
                {/* Health Status */}
                <div>
                  <h4 className="font-medium text-gray-800 mb-2">Health Status</h4>
                  <div className="flex items-center space-x-2">
                    {getHealthIcon(result.health)}
                    <span className="text-gray-700">{result.health}</span>
                  </div>
                </div>

                {/* Recommendations */}
                <div>
                  <h4 className="font-medium text-gray-800 mb-3">Care Recommendations</h4>
